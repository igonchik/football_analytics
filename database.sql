...
CREATE TABLE `twitter_ttweetsauthor` (
    `ta_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `url` varchar(200) NOT NULL,
    `name` varchar(255) NOT NULL,
    `rating` integer UNSIGNED NOT NULL,
    `maxid` BIGINT UNSIGNED NOT NULL DEFAULT 0
)
;
...
CREATE TABLE `twitter_ttweetstweet` (
    `tt_id` BIGINT UNSIGNED NOT NULL PRIMARY KEY,
...
CREATE TABLE `twitter_tworldpart` (
    `wp_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE `twitter_tworldregion` (
    `wr_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `wp_id_id` integer UNSIGNED NOT NULL,
    `coordX` integer UNSIGNED NOT NULL,
    `coordY` integer UNSIGNED NOT NULL
)
...
CREATE TABLE `twitter_tworldcountry` (
    `wc_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `wr_id_id` integer UNSIGNED NOT NULL,
    `coordX` integer UNSIGNED NOT NULL,
    `coordY` integer UNSIGNED NOT NULL
)
...
CREATE TABLE `twitter_tworldcity` (
    `wcity_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `wc_id_id` integer UNSIGNED NOT NULL,
    `coordX` integer UNSIGNED NOT NULL,
    `coordY` integer UNSIGNED NOT NULL
)
...
CREATE TABLE `twitter_tcontentvideoview` (
    `cvv_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE `twitter_tcontentarticle` (
    `ca_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `tstamp_update` datetime NOT NULL,
...
CREATE TABLE `twitter_tfootballdiv` (
    `fd_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `url` varchar(200)
)
;
...
CREATE TABLE `twitter_tfootballplayer` (
    `fp_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE `twitter_tfootballclub` (
    `fc_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `stat_url` varchar(200),
    `official_url` varchar(200),
    `twitter` varchar(200),
    `logo` varchar(100)
...
CREATE TABLE `twitter_ttweetsclubtweetrel` (
    `id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `fc_id_id` integer UNSIGNED NOT NULL,
    `tt_id_id` BIGINT UNSIGNED NOT NULL
)
;
...
CREATE TABLE `twitter_ttweetsclubhashtag` (
    `tch_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `fc_id_id` integer UNSIGNED NOT NULL,
    `th_id_id` varchar(255) NOT NULL
)
;
...
CREATE TABLE `twitter_ttweetsplayerhashtag` (
    `tph_id` integer UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
    `fp_id_id` integer UNSIGNED NOT NULL,
    `th_id_id` varchar(255) NOT NULL
)
;
